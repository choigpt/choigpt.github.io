...
| 파일 | 변경 전 | 변경 후 | 추출 대상 |
|------|---------|---------|----------|
| FeedList.tsx | 620줄 | 350줄 | → `useFeeds.ts` |
| ScheduleList.tsx | 540줄 | 400줄 | → `useSchedules.ts` |
| ChatRoom.tsx | 418줄 | 300줄 | → `useChatRoom.ts` |
...
| 영역 | 배점 | 이전 | 현재 | 변화 |
|------|------|------|------|------|
| A. 아키텍처 / 설계 | 20 | 15 | 18 | +3 |
| B. 코드 품질 / 가독성 | 20 | 14 | 17.5 | +3.5 |
| C. 상태 / 데이터 흐름 | 15 | 9 | 13 | **+4** |
| D. 성능 / UX | 15 | 11 | 12 | +1 |
| E. 테스트 / 품질보증 | 15 | 9 | 10 | +1 |
| F. 보안 / 운영 / 유지보수 | 15 | 10 | 11.5 | +1.5 |
| **합계** | **100** | **68** | **82** | **+14** |
