---
title: 채팅 도메인 — 상관 서브쿼리·Redis 리스너 미등록·N+1이 만든 성능 절벽
date: 2026-02-24
tags: [MySQL, Redis, JPA, WebSocket, STOMP, 성능최적화, 트러블슈팅, Java, 채팅, k6]
---

# 채팅 도메인 — 상관 서브쿼리·Redis 리스너 미등록·N+1이 만든 성능 절벽
...
```
메시지 전송 → Redis Publish → 아무도 Subscribe 안 함 → 메시지 소실
...
**P3 (혼합 200VU)**: 조회/전송/삭제 모두 50~91ms. 성공률 100%.
